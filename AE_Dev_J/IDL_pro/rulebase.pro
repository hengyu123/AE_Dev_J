PRO ENVI_FX_RULEBASED_DOIT_RECORD, _extra = extra
END


PRO TEST_FX_RULEBASED_DOIT, infile, rulefile, outfile
...
;  outfile = 'D:\temp\try.dat'
  ...
  classification_raster_filename = outfile
  segmentation_raster_filename = tmpath + '_segment.dat'
  vector_filename = tmpath + '_vector.shp'
  
  ENVI_DOIT, 'envi_fx_rulebased_doit',    $
    fid=fid, pos=pos, dims=dims,          $
    r_fid=r_fid, merge_level=merge_level, $
...
;    br_bands = [2,3],         $   ;计算NDVI
    ...
    vector_filename = vector_filename, /EXPORT_VECTOR_ATTRIBUTES
