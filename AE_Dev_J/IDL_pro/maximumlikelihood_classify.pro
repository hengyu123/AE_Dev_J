pro MaximumLikelihood_classify,method,infile,shapefile,outfile,singleValue,colors
compile_opt idl2
  CATCH, Error_status
  ...
  ;endif
  ;help,colors
 ; print,"attcolor: "+attColor
;  colorscount=size(colors,/N_ELEMENTS)
;  FOR co=0,colorscount-1 do begin ;循环
;    if attColor eq colors[co] then begin
;    color=co+2
;    ;print,"color: ",color
;    endif
;     if attColor eq colors[co] then break
;  ENDFOR
